...
from graxella.mnema.core.consolidation import Digest
from graxella.mnema.core.graph import Relationship
...
from graxella.mnema.services.retriever import MemoryRetriever
...
def _best_embedder() -> Any:
    ...
    try:
        from graxella.mnema.adapters.embedder.sentence_transformer import SentenceTransformerEmbedder
